...
if getgenv().Toggle then
game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace")["GAME_MAP"].EasterEggs.PlayAreaFloorPart.CFrame + Vector3.new(0,3,0)
end
...
char:WaitForChild("HumanoidRootPart").CFrame = game:GetService("Workspace")["GAME_MAP"].EasterEggs.PlayAreaFloorPart.CFrame + Vector3.new(0,3,0)
task.wait(1)
getgenv().Toggle = true
Farm()
end
